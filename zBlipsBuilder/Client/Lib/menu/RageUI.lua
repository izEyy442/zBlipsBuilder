...
--Shared.Events:On(Enums.UI.Events.NotificationEnabled, function(bool)
--    RageUI.NotificationEnabled = bool;
--end);
...
function RageUI.Banner()
    ...
    if CurrentMenu ~= nil then
        if CurrentMenu and (CurrentMenu.Display.Header) then
            ...
            if CurrentMenu.Sprite ~= nil then
                if CurrentMenu.Sprite.Dictionary ~= nil then
                    if (CurrentMenu.Sprite.Dictionary == "color") then
                        RenderSprite("color", "blank", CurrentMenu.X, CurrentMenu.Y, RageUI.Settings.Items.Title.Background.Width + CurrentMenu.WidthOffset, RageUI.Settings.Items.Title.Background.Height, nil, CurrentMenu.Sprite.Color.R,CurrentMenu.Sprite.Color.G,CurrentMenu.Sprite.Color.B,CurrentMenu.Sprite.Color.A)
                    else
            ...
            --RenderSprite("color", "copyright", CurrentMenu.X, CurrentMenu.Y, RageUI.Settings.Items.Title.Background.Width + CurrentMenu.WidthOffset, RageUI.Settings.Items.Title.Background.Height, nil);
